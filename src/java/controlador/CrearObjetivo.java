 ...
 * @author sergio
 */
@WebServlet(name = "CrearObjetivo", urlPatterns = {"/CrearObjetivo"})
public class CrearObjetivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombreobjetivo=request.getParameter("nombreobj");
            String indicador=request.getParameter("indicador");
            int tipoobj=Integer.parseInt(request.getParameter("tipoobj"));
            
            //JOptionPane.showMessageDialog(null,nombreobjetivo+" "+indicador+""+tipoobj);
            rgs.CrearObjetivo(nombreobjetivo,indicador,tipoobj,Integer.parseInt(request.getParameter("idorbita")));
