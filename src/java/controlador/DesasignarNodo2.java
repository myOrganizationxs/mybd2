 ...
 * @author sergio
 */
@WebServlet(name = "DesasignarNodo2", urlPatterns = {"/DesasignarNodo2"})
public class DesasignarNodo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reg.DesaCuenta(Integer.parseInt(request.getParameter("idusuario")));
