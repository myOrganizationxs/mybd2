 ...
 * @author sergio
 */
@WebServlet(name = "BorrarObjetivo", urlPatterns = {"/BorrarObjetivo"})
public class BorrarObjetivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //JOptionPane.showMessageDialog(null,Integer.parseInt(request.getParameter("idobjetivo")));
            rgs.BorrarObjetivo(Integer.parseInt(request.getParameter("idobjetivo")));
