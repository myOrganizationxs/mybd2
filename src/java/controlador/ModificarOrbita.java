 ...
 * @author sergio
 */
@WebServlet(name = "ModificarOrbita", urlPatterns = {"/ModificarOrbita"})
public class ModificarOrbita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            //JOptionPane.showMessageDialog(null,request.getParameter("nombredep")+" "+request.getParameter("mision")+" "+request.getParameter("vision")+" "+request.getParameter("idorbita")+" ");
            rgs.modificarorbitass(request.getParameter("nombredep"),request.getParameter("mision"),request.getParameter("vision"),Integer.parseInt(request.getParameter("idorbita")));
