 ...
 * @author sergio
 */
@WebServlet(name = "ModificarObjetivo", urlPatterns = {"/ModificarObjetivo"})
public class ModificarObjetivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //JOptionPane.showMessageDialog(null,request.getParameter("nombreobjetivo")+" "+request.getParameter("indicador")+" "+request.getParameter("tipoobj")+" "+request.getParameter("idobjetivo")+" ");
           rgs.modificarobjetivo(request.getParameter("nombreobjetivo"),request.getParameter("indicador"),request.getParameter("tipoobj"),Integer.parseInt(request.getParameter("idobjetivo")));
