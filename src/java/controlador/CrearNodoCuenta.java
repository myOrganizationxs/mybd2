 ...
 * @author sergio
 */
@WebServlet(name = "CrearNodoCuenta", urlPatterns = {"/CrearNodoCuenta"})
public class CrearNodoCuenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("idpadrenuevo",Integer.parseInt(request.getParameter("idpadrenuevo")));
            ...
            reg.CrearNodo2(Integer.parseInt(request.getParameter("idnuevo")),"Puesto", Integer.parseInt(request.getParameter("idorganizacion")));
