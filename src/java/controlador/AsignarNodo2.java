 ...
 * @author sergio
 */
@WebServlet(name = "AsignarNodo2", urlPatterns = {"/AsignarNodo2"})
public class AsignarNodo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //request.getSession().setAttribute("idpadrenuevo",Integer.parseInt(request.getParameter("idpadrenuevo")));
            ...
            reg.AsignarNodo(Integer.parseInt(request.getParameter("idnuevo")),Integer.parseInt(request.getParameter("idusuario")));
