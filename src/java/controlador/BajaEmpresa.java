 ...
 * @author sergio
 */
@WebServlet(name = "BajaEmpresa", urlPatterns = {"/BajaEmpresa"})
public class BajaEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reg.revisar_orbita("Default","Default","Default", Integer.parseInt(request.getParameter("idnuevo")),1);
        reg.CrearNodo(Integer.parseInt(request.getParameter("idnuevo")),"Puesto", Integer.parseInt(request.getParameter("idorganizacion")));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        registro reg = new registro();
        String ced = String.valueOf(request.getParameter("idorganizacion"));
        int variable=Integer.parseInt(ced);
        //JOptionPane.showMessageDialog(null,variable);
        reg.BajaEmpresa(variable);
