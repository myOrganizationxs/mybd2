 ...
 * @author sergio
 */
@WebServlet(name = "CrearCuenta2", urlPatterns = {"/CrearCuenta2"})
public class CrearCuenta2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            myr.crearcuenta(0,01,01,1990,1,1,1);
            response.sendRedirect("usuarioslibres.jsp?idnuevo="+request.getParameter("idnuevo")+"&&idpadrenuevo="+request.getParameter("idpadrenuevo")+"&&idnodo="+request.getParameter("idnodo")+"&&nodopadre="+request.getParameter("nodopadre")+"&&cargo="+request.getParameter("cargo")+"&&idorganizacion="+request.getParameter("idorganizacion")+"&&nombreorg="+request.getParameter("nombreorg")+"&&idorbita="+request.getParameter("idorbita")+"&&nombredep="+request.getParameter("nombredep")+"&&mision="+request.getParameter("mision")+"&&vision="+request.getParameter("vision")+"&&posicion="+request.getParameter("posicion")+"");
